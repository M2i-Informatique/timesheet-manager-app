...
@section('title', 'Nouveau congé salarié')
...
<div class="p-6">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-xl font-semibold text-gray-900">Nouveau congé salarié</h1>
    </div>

    <!-- Formulaire -->
    <div class="bg-white rounded-lg shadow">
        <div class="p-6">
            <form method="POST" action="{{ route('admin.worker-leaves.store') }}">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="reason" id="reason" rows="3" placeholder="Motif ou commentaire optionnel..."
                                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('reason') border-red-300 @enderror">{{ old('reason') }}</textarea>
                        @error('reason')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
