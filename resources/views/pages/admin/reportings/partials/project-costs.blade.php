...
<div class="mb-6 flex items-center justify-center">
    <span
        ...
        <a
            ...
            class="px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-blue-50 hover:text-gray-900 focus:relative inline-flex items-center gap-1">
        ...
        <span
            class="px-3 py-1.5 text-md font-bold text-gray-700 bg-blue-50 flex items-center">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
    <!-- KPI Heures Salariés -->
    <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-blue-50 p-6 shadow-sm h-full">
        <div>
            <p class="text-sm text-gray-500">Heures Salariés</p>
        ...
        <div class="inline-flex gap-2 rounded-sm {{ $workerHoursChangePercent > 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600' }} p-1">
    ...
    <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-blue-50 p-6 shadow-sm h-full">
        ...
        <div class="inline-flex gap-2 rounded-sm {{ $hoursChangePercent > 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600' }} p-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- KPI Coût Total -->
    <article class="flex items-end justify-between rounded-lg border border-gray-100 bg-green-50 p-6 shadow-sm h-full">
        <div>
        ...
        <div class="inline-flex gap-2 rounded-sm {{ $costChangePercent > 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600' }} p-1">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
