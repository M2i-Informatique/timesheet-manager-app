...
@php
    ...
    $trackingIcon = '<svg class="w-4 h-4 inline-block align-center text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
    </svg>';

    $downloadIcon = '<svg class="w-4 h-4 inline-block align-center text-blue-600" xmlns="http://www.w3.org/2000/svg"
...
@section('content')
    <div class="max-w-screen-xl flex mx-auto gap-16 pt-24">
        ...
        <x-sidebars.nav :links="$links" title="Sur cette page" infoTitle="Informations">
            <x-slot:info>
